...
![image-20221101114901994](images/image-20221101114901994.png)
...
![image-20221102170636819](images/image-20221102170636819.png)
...
![image-20221102171726357](images/image-20221102171726357.png)
...
![image-20221102173424094](images/image-20221102173424094.png)
...
![image-20221102192013512](images/image-20221102192013512.png)
...
![image-20221102192638049](images/image-20221102192638049.png)
...
![image-20221102193823817](images/image-20221102193823817.png)
...
![image-20221102194550659](images/image-20221102194550659.png)
...
![image-20221102200048553](images/image-20221102200048553.png)
...
![image-20221102200824210](images/image-20221102200824210.png)
...
![image-20221103095431320](images/image-20221103095431320.png)

#### 3.2.5  插入和删除

![image-20221103100520279](images/image-20221103100520279.png)
...
![image-20221103101240816](images/image-20221103101240816.png)
...
![image-20221103104653943](images/image-20221103104653943.png)

交换后：

![image-20221103104727498](images/image-20221103104727498.png)
...
![image-20221103111210390](images/image-20221103111210390.png)

底层原理：

![image-20221103113024255](images/image-20221103113024255.png)

#### 3.3.2  构造函数

![image-20221103113123945](images/image-20221103113123945.png)
...
![image-20221103150636524](images/image-20221103150636524.png)

#### 3.3.4  大小操作

 `deque` 没有 `capacity` 的概念，它可以无限地存放数据。

 ![image-20221103150946939](images/image-20221103150946939.png)

#### 3.3.5  插入和删除

![image-20221103151139791](images/image-20221103151139791.png)
...
#### 3.3.6  数据存取
 ...
 ![image-20221103152721153](images/image-20221103152721153.png)
...
![image-20221103153707985](images/image-20221103153707985.png)
...
#### 3.6.2  常用接口
 ...
 ![image-20221103154215490](images/image-20221103154215490.png)
...
![image-20221103155326468](images/image-20221103155326468.png)
...
![image-20221103155635631](images/image-20221103155635631.png)

#### 3.6.3  赋值和交换

 ![image-20221105162517166](images/image-20221105162517166.png)

#### 3.6.4  大小操作

![image-20221105162712249](images/image-20221105162712249.png)

#### 3.6.5  插入和删除

![image-20221105162741686](images/image-20221105162741686.png)

#### 3.6.6  数据存取

`list` 不是用连续线性空间存储数据，相邻元素的地址可能不连续，因此它不支持随机访问，不支持用下标直接跳跃式的访问。

![image-20221105162913824](images/image-20221105162913824.png)
...
![image-20221105163618182](images/image-20221105163618182.png)
...
![image-20221105165409960](images/image-20221105165409960.png)
...
![image-20221105165827888](images/image-20221105165827888.png)
...
![image-20221105170008406](images/image-20221105170008406.png)

#### 3.7.5  查找和统计

![image-20221105170111672](images/image-20221105170111672.png)
...
![image-20221105170624797](images/image-20221105170624797.png)
...
![image-20221105171310815](images/image-20221105171310815.png)
...
![image-20221107104134929](images/image-20221107104134929.png)
...
![image-20221107104901252](images/image-20221107104901252.png) 

#### 3.8.4  插入和删除

![image-20221107105034727](images/image-20221107105034727.png)
...
![image-20221107110527690](images/image-20221107110527690.png)
...
![image-20221107195341134](images/image-20221107195341134.png)
...
![image-20221107200054783](images/image-20221107200054783.png)
...
![image-20221107201134957](images/image-20221107201134957.png)
...
![image-20221108095428398](images/image-20221108095428398.png)

#### 5.2.1  find

功能描述：查找指定元素，找到返回指定元素的迭代器，找不到则返回结束迭代器 `end()`。

![image-20221108095654118](images/image-20221108095654118.png)
...
![image-20221108101435111](images/image-20221108101435111.png)
...
功能描述：查找相邻重复元素。
 ...
 ![image-20221108102853334](images/image-20221108102853334.png)
...
![image-20221108103549943](images/image-20221108103549943.png)
...
![image-20221108104434197](images/image-20221108104434197.png)
...
![image-20221108113049123](images/image-20221108113049123.png)
...
![image-20221108170403217](images/image-20221108170403217.png)

#### 5.3.1  sort

功能描述：排序。

![image-20221108170456075](images/image-20221108170456075.png)
...
![image-20221108171006574](images/image-20221108171006574.png)
...
![image-20221108171904739](images/image-20221108171904739.png)
...
![image-20221108172434945](images/image-20221108172434945.png)

### 5.4  常用拷贝和替换算法

![image-20221108172550079](images/image-20221108172550079.png)

#### 5.4.1  copy

功能描述：将容器内指定范围的元素拷贝到另一容器中。

![image-20221108172656171](images/image-20221108172656171.png)
...
![image-20221109095555392](images/image-20221109095555392.png)
...
![image-20221109100016787](images/image-20221109100016787.png)
...
![image-20221109100655617](images/image-20221109100655617.png)
...
![image-20221109101045275](images/image-20221109101045275.png)

#### 5.1.1  accumulate

功能描述：计算区间内的容器元素累计总和。

![image-20221109101145445](images/image-20221109101145445.png)
...
![image-20221109101453287](images/image-20221109101453287.png)
...
![image-20221109101701547](images/image-20221109101701547.png)

![image-20221109103445232](images/image-20221109103445232.png)

![image-20221109103523862](images/image-20221109103523862.png)

#### 5.6.1  set_intersection

功能描述：求两个容器的交集。

![image-20221109101809313](images/image-20221109101809313.png)
...
![image-20221109102623526](images/image-20221109102623526.png)
...
![image-20221109103110951](images/image-20221109103110951.png)
...
![image-20221122161149828](images/image-20221122161149828.png)
...
![image-20221122162521025](images/image-20221122162521025.png)
...
![Snipaste_2022-11-22_22-34-31](images/Snipaste_2022-11-22_22-34-31.png)
...
![image-20230116103604707](images/image-20230116103604707.png)
...
![image-20230118095329252](images/image-20230118095329252.png)
...
![image-20230118111458801](images/image-20230118111458801.png)
...
![image-20230118115601113](images/image-20230118115601113.png)

#### 6.3.4 删除命令

在 vim 中所谓的删除就是剪切。

![image-20230118160311884](images/image-20230118160311884.png)
...
![image-20230118161410822](images/image-20230118161410822.png)
...
![image-20230118162538258](images/image-20230118162538258.png)
...
![image-20230118162752990](images/image-20230118162752990.png)

#### 6.3.8 替换

命令模式下的替换功能并不强，常用于某个单字符的替换，当需要大规模的修改文件内容时，应切换到编辑模式再进行操作。

![image-20230118163124786](images/image-20230118163124786.png)

#### 6.3.9 查找

在 vim 的命令模式下一共有三种查找方式，首先需要在键盘上输入对应的字符，然后按回车键，vim 就会进行关键字匹配，之后就可以通过 `n` 或者 `N` 进行关键字之间的切换了。

![image-20230118163840489](images/image-20230118163840489.png)
...
![image-20230119150215558](images/image-20230119150215558.png)
...
![image-20230119151740828](images/image-20230119151740828.png)
...
![image-20230119153043467](images/image-20230119153043467.png)

#### 6.4.3 替换

替换操作对应的命令是 `s`，并且可以为其指定参数，默认情况下只替换相关行的第一个满足条件的关键字，如果需要整行替换需要加参数 `/g`。

![image-20230119153917582](images/image-20230119153917582.png)
...
![image-20230119155510214](images/image-20230119155510214.png)
...
![image-20230126113146586](images/image-20230126113146586-16747039077221.png)
...
![image-20230126153331564](images/image-20230126153331564.png)
...
![image-20230127152737380](images/image-20230127152737380.png)
...
![image-20230127154828597](images/image-20230127154828597.png)
...
![Snipaste_2023-01-27_15-54-49](images/Snipaste_2023-01-27_15-54-49.png)

> **undefined reference（未定义的引用）：**在项目中能找到对应函数的声明（即能找到对应的头文件），但是却找不到这些函数的定义。

正确用法：需要指定要使用的库及其所在的文件路径。

![Snipaste_2023-01-27_16-07-17](images/Snipaste_2023-01-27_16-07-17.png)
...
![image-20230227194829482](images/image-20230227194829482.png)
...
![image-20230227195551229](images/image-20230227195551229.png)

需要指定头文件搜索路径：

![image-20230227195738538](images/image-20230227195738538.png)

打包为共享库：

![image-20230227195941442](images/image-20230227195941442.png)
...
![image-20230227200519087](images/image-20230227200519087.png)

编译测试程序：需要指定库的文件路径和名字

![image-20230227200733953](images/image-20230227200733953.png)

#### 8.2.4 解决动态库无法加载的问题

![image-20230227201047915](images/image-20230227201047915.png)

![image-20230227201013698](images/image-20230227201013698.png)
...
![image-20230227205227509](images/image-20230227205227509.png)
...
![image-20230228105009491](images/image-20230228105009491.png)
...
![image-20230228105440291](images/image-20230228105440291.png)
...
![image-20230228162023558](images/image-20230228162023558.png)
...
![image-20230228162808515](images/image-20230228162808515.png)
...
![image-20230228164551763](images/image-20230228164551763.png)
...
![image-20221123104355396](images/image-20221123104355396.png)
...
![image-20221123110301687](images/image-20221123110301687.png)
...
![image-20221123164619682](images/image-20221123164619682.png)
...
![image-20221123194308595](images/image-20221123194308595.png)
...
![image-20221124223642105](images/image-20221124223642105.png)
...
![image-20221124171215483](images/image-20221124171215483.png)
...
![image-20221125114944007](images/image-20221125114944007.png)
...
![image-20221125170908198](images/image-20221125170908198.png)
...
![image-20221126103631316](images/image-20221126103631316.png)
...
![image-20221126161811762](images/image-20221126161811762.png)
...
![image-20221126223920017](images/image-20221126223920017.png)
...
![image-20221127101516800](images/image-20221127101516800.png)
...
![image-20221127145810030](images/image-20221127145810030.png)
