...
async def main():
    ...
    async with aiohttp.ClientSession() as session:
        with tqdm(total=len(prompt_dict), desc="处理进度", unit="个", position=0, leave=True) as pbar:
