...
execute_model():
    _preprocess():
        _execute_mm_encoder(): -> multimodal_embeddings (encoder_output)
        ...
        _gather_mm_embeddings() -> mm_embeds, is_mm_embed
        
        model.embed_input_ids(): -> inputs_embeds
            _embed_text_input_ids() -> text_embeddings
