...
export ASCEND_SLOG_PRINT_TO_FILE=1
export ASCEND_SLOG_PATH=/tmp/ascend_slog
```
...
non_torch_memory after profiling is 0.89 G

`torch_npu.npu_fusion_attention`:

non_torch_memory after profiling is 0.87 G
non_torch_memory after first req is 1.03 G
